...
|---|---|---|---|---|---|---|---|---|
| 1 | 연봉 실수령액 계산기 | /tax/net-salary | 연봉 실수령액, 연봉 4000 실수령액 | 최상 | 있음 | 연중 | 연봉별 실수령액 표로 롱테일 검색어를 한 번에 잡기 | 대기 |
| 2 | 실업급여 계산기 | /work/unemployment-benefit | 실업급여 계산, 실업급여 조건 | 최상 | 없음 | 연중 | 조건과 신청 절차가 주인공, 계산기는 도구 | 대기 |
| 3 | 퇴직금 계산기 | /work/severance | 퇴직금 계산기, 퇴직금 계산 | 최상 | 없음 | 연중 | 근속·평균임금 예시, 퇴직소득세까지 연결 | 대기 |
